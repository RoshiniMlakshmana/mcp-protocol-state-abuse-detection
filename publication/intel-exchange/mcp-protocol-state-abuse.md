...
security-audit schema of its own), 68 deterministic test scenarios (363 events) across normal,
controlled-attack, and adversarial-stress corpora, 104 automated tests, and documented
...
- **Validation/stress** (`data/validation/`) — 37 scenarios, 163 events: adversarial-but-benign
  and boundary-condition fixtures designed specifically to expose false positives, plus
  evasion-illustration fixtures documenting what these rules cannot see.
...
|---|---|---|---|---|---|---|
| 1 | 8 | 0 | 60 | 0 | 1.000 | 1.000 |
| 2 | 9 | 0 | 59 | 0 | 1.000 | 1.000 |
| 3 (excl. experimental) | 7 | 0 | 60 | 0 | 1.000 | 1.000 |
...
regression-verified against all 104 tests.
...
`tests/validation/language_equivalence.test.js`, zero disagreements across 68 scenarios).
